...
import 'Bar_graph/PsyLast6_month.dart';
import 'Bar_graph/PsyLast_7.dart';
import 'Bar_graph/PsyLast_year.dart';
import 'Bar_graph/PsyTotal_perfm.dart';
import 'Bar_graph/Psylast3_month.dart';
import 'Bar_graph/PsyLastMonth.dart';

class PsyPerformence extends StatefulWidget {
  const PsyPerformence({super.key});

  @override
  State<PsyPerformence> createState() => _PsyPerformenceState();
}

class _PsyPerformenceState extends State<PsyPerformence> {
  ...
  Widget _buildSelectedContainer() {
    switch (_selectedItem) {
      ...
      case 'Last 3 Months':
        return const Center(child: PsyLast3Month());
      case 'Last 6 months':
        return const Center(child: PsyLast6Month());
      case 'Last year':
        return const Center(
          child: PsyLastYear(),
        );
